...
// Structured Buffers
//--------------------------------------------------------------------------------------
Buffer<unsigned int> Input : register( t0 );
RWBuffer<unsigned int> Data : register( u0 );
...
void BitonicSortUint( uint3 Gid : SV_GroupID, 
...
void MatrixTransposeUint( uint3 Gid : SV_GroupID, 
                      uint3 DTid : SV_DispatchThreadID, 
                      uint3 GTid : SV_GroupThreadID, 
                      uint GI : SV_GroupIndex )
{
